...
export const SECTION_DATA: Section[] = [
    { // 0 degrees
        ...
        items: [
            { text: "UI/UX Design", position: [-1, 2.5, 1.5] },
            { text: "Frontend Development with AI", position: [-0.5, 0.5, 2.2] },
            { text: "API Integration", position: [0.8, 1, 2] },
            { text: "Cloud Solutions", position: [1.5, 2.8, 1.3] },
        ]
    },
    { // 90 degrees
        id: 'our-work',
    ...
    { // 180 degrees
        ...
        items: [
            { text: "Innovation", position: [-1.5, 1.8, -1.8] },
            { text: "Performance", position: [0, 0.5, -2.5] },
            { text: "Scalability", position: [1.8, 2.2, -2] },
        ]
    },
    { // 270 degrees
        id: 'contact-us',
